...
Faglærer er sponsor for dette prosjektet, ansvarlig for godkjenning av denne prosjektplanen og eventuelle endringer under gjennomføringen.

### Kunde

Modino AS representerer sluttbrukerne av prosjektet, har deltatt i definisjon av prosjektomfanget og vil være ansvarlig for godkjenning av kravene og aksept av de endelige leveransene.

### Forretningscase

[Forretningscase er ikke utarbeidet for dette prosjektet.]
...
Alt arbeid som leveres inn i sluttproduktet skal verifiseres av prosjektteamet som har produsert leveransene, for å sikre at leveransene er i samsvar med alle krav og er egnet for formålet. Intern peer-to-peer review benyttes som verifikasjonsmetode, beskrevet nærmere i seksjon 10 – Kvalitet.
...
[Avhengighetsdiagram er ikke utarbeidet for dette prosjektet.]
...
[Budsjett er ikke relevant for dette prosjektet.]
...
[Ingen uavklarte saker ved planleggingens slutt.]

---

## Interessenter

| Interessent | Rolle | Behov |
|-------------|-------|-------|
| Modino AS | Oppdragsgiver | Datadrevet beslutningsstøtte i recommerce-prosessen |
| Faglærer | Sponsor og veileder | Faglig kvalitet og etterprøvbar metode |
| Birgitte & Vera | Prosjektgruppe | Gjennomføring og leveranse av forskningsprosjektet |
...
[Anskaffelser er ikke relevant for dette prosjektet.]

---

## Endringskontrollprosess

Eventuelle endringer i prosjektomfang, fremdriftsplan eller krav etter at denne planen er godkjent, avklares med faglærer før iverksetting. Endringer dokumenteres i prosjektplanen med dato og begrunnelse.
